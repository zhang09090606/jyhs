...
<body>
	<form action="my.add_check.php" method="post">
		...
		<div class="input_div">
			<font size="+1">联系人：</font><input class="input" id="peo" placeholder="请填写联系人" name="peo">
			<hr size="1px" width="95%"  align="center" color=#E4E4E4> 
			<font size="+1">手机号：</font>
			<input class="input" id="tel" placeholder="请填写手机号" name="tel">

			<hr size="1px" width="95%" align="center" color=#E4E4E4> 
			<div class="div" onClick="location='my.add.map.php'" ><font size="+1"><?php echo "	您选择地址为：  ".$add;?></font>
			<img src="images/arrow.png" class="div_div_img"></div>	
			<hr size="1px" width="95%" align="center" color=#E4E4E4> 

			<font size="+1">详细地址:</font><input name="adds" type="text" id="adds" class="add_input" width="100%" placeholder="   请详细到门牌号" id="sever_add">
			<hr size="1px" width="95%" align="center" color=#E4E4E4>
			...
			<input name="add" value="<?php echo $add?>" id="add" hidden="">
