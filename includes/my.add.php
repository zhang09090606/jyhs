...
<body>
	...
	<img src="images/fanhui.png" class="arrow" onclick="window.history.back(-1);" >
		...
		<div class="main" id="main">
			...
			<p><?php echo $v['addname']?> <?php echo $v['inf']?>
			<input hidden id="delete" type="button" value="删除" class="push_button red" style="width: 50px;height: 25px;font-size: 15px;line-height: 30px;margin: 0px;float:right;right: 10px">
