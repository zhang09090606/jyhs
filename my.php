...
<body>
	...
	<div style="height: 460px;margin: 0px;padding: 0px;">
	...
	<div class="div3">
				<li>
					<ul id="a1" onClick="location='order.wait.php'"><center><img src="images/issumit.png"></center></ul>	
					<ul id="a2" onClick="location='order.run.php'"><center><img src="images/qiangdan.png"></center></ul>	
					<ul id="a3" onClick="location='order.finish.php'"><center><img src="images/recovery.png"></center></ul>	
				</li>
	</div>
	<hr color="#EAEAEA" size="4px">
	...
	<hr color="#EAEAEA" size="1px">
	<div class="main_div" onClick="location='pai.php'">
		<img src="images/pai.png" class="main_img">
		<p class="main_p">回收排行榜</p>
		<img src="images/arrow.png" class="div_div_img">
	</div>
	<hr color="#EAEAEA" size="4px">
	...
	<div class="botten_div">
		<table class="botten_table">
			<tr>
				...
				<td  align="center" id="pic2"><img src="images/botten2.png" id="p2" width="38px" height="45px"></td>
