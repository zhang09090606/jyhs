...
<body>
	<div id="wrap">
		<div class="tab">
			<ul>
				<li><a href="user.inc.php">添加回收员</a>
				</li>
				<li><a href="javascript:;" class="on">回收员管理</a>
				</li>
			...
			<form action="hsuser_check.php" method="post" name="myform" class="demoform">
				<table cellspacing="0" class="sub">
					...
					<tr>
						...
						<td><input type="password" name="pwd" id="password" size="20" value="<?php echo $row['pwd']?>"/>
							<td> </td>
					</tr>
					<tr>
						<td width="100" align="right">确认密码：</td>
						<td><input type="password" name="repwd" id="password_t" size="20" value="<?php echo $row['pwd']?>"/>
						</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="addname" type="text" value="<?php echo $row['addname']?>" id="sever_add" readonly>
						</td>
						<td></td>
					</tr>
					<tr class="bg2">
...
<script src="js/ajax_hsuser.edit.js"></script>
</html>