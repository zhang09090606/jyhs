...
if(empty($_SESSION['hsname'])){
 ...
 $rows = $Db->get_all( "order", "hsuser='$name'"." and isfinish='是' and hsshow='是'" );
...
<body>
	<div class="head" align="center">
		<font color="#FFFFFF" size="+2">已完成订单</font>
	</div>
	...
	<div class="main_bottom">
		...
		<input id="<?php echo $v['id']?>" onClick="delete0()" type="button" value="删除订单" class="main_delete" name="delete" id="delete">
	</div>
