...
<body style="margin:0; padding:0;">
	...
	<div class="main_div">
		...
		<div class="form_div">
			...
			<span class="main_span1" onClick="location='repwd.php'">找回密码</span>
			...
			<div align="center" style="position: relative; top:120px"><p style="font-size:12px">登录及代表阅读并同意<font color="#18EC2A">服务条款	</font></p></div>
		</div>
	</div>
</body>
</html>
