...
<body>
	...
	<div class="botten_div">
		<div class="price">您的绿化值为：
			...
			<input id="inc" type="button" onClick="location='jfshop.inc.php'" value="已兑换物品" class="push_button red" style="width: 100px;height: 30px;font-size: 15px;line-height: 30px;margin: 0px;float:right;right: 20px;top:5px">
		</div>
