...
$name = $_SESSION[ 'name' ];
$rows = $Db->get_all( "order", "name='$name'" . " and isstart=" . "'是'" . " and isfinish=" . "'否'" );
		...
		<div class="main_div">
			...
			?>
				...
				<div class="main_bottom_div">
					<p>共
						<?php echo count($row);?>件废品，共计￥
						<?php echo $sum?>元</p>
				</div>
				<input id="<?php echo $v['id']?>" onClick="cencel()" type="button" value="取消订单" class="main_delete" name="delete" id="delete">
				<input id="<?php echo $v['id']?>" onClick="finish()" type="button" value="完成订单" class="main_delete" name="delete" id="delete">
			</div>
